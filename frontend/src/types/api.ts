...
export interface Doctor { id: UUID; first_name: string; last_name: string; npi?: string | null; status: string; engagement_score: number; prescription_trend: number }
...
export interface CalendarItem { id: UUID; type: string; title: string; starts_at: string; ends_at: string; hcp_id?: UUID | null; hcp_name?: string | null; status?: string }
