...
class AIOrchestratorService:
    ...
    async def postcall(self, payload: PostCallRequest) -> PostCallExtraction:
        return await PostCallExtractionAgent(self.provider).extract(payload.doctor_id, payload.note)
